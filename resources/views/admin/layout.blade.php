...
<head>
  ...
  <title>Admin Dashboard - Train Ticket Booking System</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/tickets">Ticket Price</a>
          </div>
        </div>
      </li>
    </ul>
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <script> document.write(new Date().getFullYear()); </script>
              <b><a href="https://entiresoln.com/" target="_blank">Train Ticket Booking System.</a></b>
            </span>
          </div>
        </div>
      </footer>
